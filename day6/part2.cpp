...
int main()
{
	...
	auto part1_result = numeric_limits<int>::min();
	for (const auto& p : positions_by_point)
	{
		part1_result = max(part1_result, p.second);
	}

	cout << "Part1: " << part1_result << '\n';
	cout << "Part2: " << part2_result << '\n';
	return 0;
}
